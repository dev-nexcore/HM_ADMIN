...
const AdminLogin = () => {
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gray-100">
      <div className="flex flex-col lg:flex-row w-full h-full bg-white shadow-2xl overflow-hidden">
        {/* Left Panel */}
       <div className="w-full lg:w-1/2 bg-[#9AAA87] flex flex-col items-center justify-center text-center px-6 py-10 lg:px-16 lg:py-0 rounded-none lg:rounded-r-[100px] shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
          <h2 className="text-3xl sm:text-4xl font-bold text-black mb-12">Welcome Back!</h2>
          <img src="/photos/logo.png" alt="Logo" className="w-[210px] h-[190px] bg-white p-4 rounded-lg mb-14 object-contain" />
        ...
        {/* Right Panel */}
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-10 sm:px-10 lg:px-16 bg-white">
  ...
  <div>
    ...
    <div className="text-right mt-2">
      <a href="/forgetpassword" className="text-blue-600 text-sm font-medium hover:underline">Forget Password?</a>
    </div>
  </div>
