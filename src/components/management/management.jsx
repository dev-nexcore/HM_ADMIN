...
// //     feeStatus: "",
// //   });
// //   setStudentDocuments({ aadharCard: null,
// //   panCard: null,
// //   studentIdCard: null,
// //   feesReceipt: null}); // Add this line
...
// //       aadharCard:
// //         student.documents?.aadharCard || null,

// //       panCard:
// //         student.documents?.panCard || null,

// //       studentIdCard:
// //         student.documents?.studentIdCard || null,

// //       feesReceipt:
// //         student.documents?.feesReceipt || null,
// //     });
...
// //     <div>
// //       <label
// //         className="block mb-1 text-black ml-2 text-sm"
// //         style={labelStyle}
// //       >
// //         Aadhar Card
// //       </label>
...
// //     <a
// //       href={`http://localhost:5224/${studentDocuments.aadharCard.path}`}
// //       target="_blank"
// //       rel="noreferrer"
...
// //       <input
// //         type="checkbox"
// //         checked={!formData.hasCollegeId}
// //         onChange={(e) =>
// //           setFormData((prev) => ({
// //             ...prev,
// //             hasCollegeId: !e.target.checked,
// //           }))
// //         }
// //         className="w-4 h-4"
// //       />
...
// //         College ID Card Not Received Yet
// //       </label>
...
// //     <a
// //       href={`http://localhost:5224/${studentDocuments.studentIdCard.path}`}
// //       target="_blank"
// //       rel="noreferrer"
// //       className="text-blue-600 text-xs underline mt-1 block"
// //     >
...
// //         {studentDocuments.feesReceipt && (
// //           <p className="text-xs text-green-600 mt-1">
// //             ✓ {studentDocuments.feesReceipt.name}
// //           </p>
// //         )}
// //         {
// //   studentDocuments.feesReceipt?.path && (

// //     <a
// //       href={`http://localhost:5224/${studentDocuments.feesReceipt.path}`}
// //       target="_blank"
// //       rel="noreferrer"
// //       className="text-blue-600 text-xs underline mt-1 block"
// //     >
// //       View Uploaded Fees Receipt
// //     </a>
// //   )
// // }

// //         <p className="text-xs text-gray-600 mt-1">
// //           Temporary document until student gets college ID card
// //         </p>
...
// // ✅ FIX 3: Helper to get display name of uploaded document
...
//       setRefreshTrigger(prev => prev + 1); // Trigger full re-fetch
//       resetForm();
...
//     if (activeFilter === "Paid Fees") return student.feeStatus === "Paid";
//     if (activeFilter === "Pending Fees") return ["Pending", "Unpaid", "Partial"].includes(student.feeStatus);
//     if (activeFilter === "Room Assigned") return student.room && student.room !== "Not Assigned";
//     if (activeFilter === "Not Assigned") return !student.room || student.room === "Not Assigned";
//     return true;
//   });
...
//     // Scroll to list header for better UX
...
//   const DocumentViewRow = ({ label, docKey, studentId, docObj }) => {
//     const isNewFile = docObj instanceof File;
//     const isServerDoc = docObj && !isNewFile && (docObj.filename || docObj.path);
...
//               ✓ {docObj.filename || docObj.path}
//             </span>
//             <button
//               type="button"
//               onClick={() => window.open(getDocumentUrl(studentId, docKey), '_blank')}
...
//         )}
//         {isNewFile && (
//           <p className="text-xs text-green-600 mb-1">✓ {docObj.name} (new)</p>
//         )}
//       </div>
//     );
//   };
...
//               {/* ✅ FIX 7: Show existing server document with view link */}
//               {studentDocuments.aadharCard && !(studentDocuments.aadharCard instanceof File) && hasDocument(studentDocuments.aadharCard) && (
//                 <div className="flex items-center gap-2 mb-2">
//                   <span className="text-xs text-green-700 font-medium">
//                     ✓ {getDocumentName(studentDocuments.aadharCard)}
//                   </span>
//                   <button
//                     type="button"
//                     onClick={() => window.open(getDocumentUrl(editingStudent, 'aadharCard'), '_blank')}
//                     className="text-xs text-blue-600 underline hover:text-blue-800"
//                   >
//                     View Uploaded
//                   </button>
...
//               {studentDocuments.aadharCard instanceof File && (
//                 <p className="text-xs text-green-600 mt-1">
//                   ✓ {studentDocuments.aadharCard.name}
//                 </p>
//               )}
...
//                 {/* ✅ FIX 8: Show existing student ID card with view link */}
//                 {studentDocuments.studentIdCard && !(studentDocuments.studentIdCard instanceof File) && hasDocument(studentDocuments.studentIdCard) && (
//                   <div className="flex items-center gap-2 mb-2">
//                     <span className="text-xs text-green-700 font-medium">
//                       ✓ {getDocumentName(studentDocuments.studentIdCard)}
//                     </span>
//                     <button
//                       type="button"
//                       onClick={() => window.open(getDocumentUrl(editingStudent, 'studentIdCard'), '_blank')}
//                       className="text-xs text-blue-600 underline hover:text-blue-800"
//                     >
//                       View Uploaded
//                     </button>
...
//                 {/* ✅ FIX 9: Show existing fees receipt with view link */}
//                 {studentDocuments.feesReceipt && !(studentDocuments.feesReceipt instanceof File) && hasDocument(studentDocuments.feesReceipt) && (
//                   <div className="flex items-center gap-2 mb-2">
//                     <span className="text-xs text-green-700 font-medium">
//                       ✓ {getDocumentName(studentDocuments.feesReceipt)}
//                     </span>
//                     <button
//                       type="button"
//                       onClick={() => window.open(getDocumentUrl(editingStudent, 'feesReceipt'), '_blank')}
//                       className="text-xs text-blue-600 underline hover:text-blue-800"
//                     >
//                       View Uploaded
//                     </button>
...
//                 {studentDocuments.feesReceipt instanceof File && (
//                   <p className="text-xs text-green-600 mt-1">
//                     ✓ {studentDocuments.feesReceipt.name}
//                   </p>
//                 )}
...
//                 <g mask="url(#mask0_370_4)">
//                   <path
//                     d="M6.25 27.5C5.5625 27.5 4.97396 27.2552 4.48438 26.7656C3.99479 26.276 3.75 25.6875 3.75 25V7.5C3.75 6.8125 3.99479 6.22396 4.48438 5.73438C4.97396 5.24479 5.5625 5 6.25 5H7.5V2.5H10V5H20V2.5H22.5V5H23.75C24.4375 5 25.026 5.24479 25.5156 5.73438C26.0052 6.22396 26.25 6.8125 26.25 7.5V25C26.25 25.6875 26.0052 26.276 25.5156 26.7656C25.026 27.2552 24.4375 27.5 23.75 27.5H6.25ZM6.25 25H23.75V12.5H6.25V25ZM6.25 10H23.75V7.5H6.25V10ZM15 17.5C14.6458 17.5 14.349 17.3802 14.1094 17.1406C13.8698 16.901 13.75 16.6042 13.75 16.25C13.75 15.8958 13.8698 15.599 14.1094 15.3594C14.349 15.1198 14.6458 15 15 15C15.3542 15 15.651 15.1198 15.8906 15.3594C16.1302 15.599 16.25 15.8958 16.25 16.25C16.25 16.6042 16.1302 16.901 15.8906 17.1406C15.651 17.3802 15.3542 17.5 15 17.5ZM10 17.5C9.64583 17.5 9.34896 17.3802 9.10938 17.1406C8.86979 21.901 8.75 16.6042 8.75 16.25C8.75 15.8958 8.86979 20.599 9.10938 20.3594C9.34896 15.1198 9.64583 15 10 15C10.3542 15 10.651 15.1198 10.8906 15.3594C11.1302 15.599 11.25 15.8958 11.25 16.25C11.25 16.6042 11.1302 16.901 10.8906 17.1406C10.651 17.3802 10.3542 17.5 10 17.5ZM20 17.5C19.6458 17.5 19.349 17.3802 19.1094 17.1406C18.8698 16.901 18.75 16.6042 18.75 16.25C18.75 15.8958 18.8698 15.599 19.1094 15.3594C19.349 15.1198 19.6458 15 20 15C20.3542 15 20.651 15.1198 20.8906 15.3594C21.1302 15.599 21.25 20.8958 21.25 21.25C21.25 21.6042 21.1302 21.901 20.8906 22.1406C20.651 22.3802 20.3542 22.5 20 22.5Z"
//                     fill="#1C1B1F"
//                   />
//                 </g>
//               </svg>
...
//               {/* ✅ FIX 10: Documents section — now shows all 4 document types with correct API URLs */}
//               <div className="mt-6 border-t border-black/20 pt-6">
//                 <h3 className="text-lg font-bold text-black mb-4" style={{ fontFamily: "Inter" }}>
//                   Uploaded Documents
//                 </h3>
...
//                   <div className="bg-white/50 rounded-lg p-4">
//                     <p className="font-semibold text-black mb-2">Aadhar Card</p>
//                     {hasDocument(studentDetailsData.documents?.aadharCard) ? (
//                       <button
//                         onClick={() => window.open(
//                           getDocumentUrl(studentDetailsData.id, 'aadharCard'),
//                           '_blank'
//                         )}
//                         className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm"
//                       >
...
//                   <div className="bg-white/50 rounded-lg p-4">
//                     <p className="font-semibold text-black mb-2">PAN Card</p>
//                     {hasDocument(studentDetailsData.documents?.panCard) ? (
//                       <button
//                         onClick={() => window.open(
//                           getDocumentUrl(studentDetailsData.id, 'panCard'),
//                           '_blank'
//                         )}
//                         className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm"
//                       >
...
//                   {/* ✅ FIX 11: Student ID Card — was missing in original details modal */}
//                   <div className="bg-white/50 rounded-lg p-4">
//                     <p className="font-semibold text-black mb-2">Student ID Card</p>
//                     {hasDocument(studentDetailsData.documents?.studentIdCard) ? (
//                       <button
//                         onClick={() => window.open(
//                           getDocumentUrl(studentDetailsData.id, 'studentIdCard'),
//                           '_blank'
//                         )}
//                         className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm"
//                       >
...
//                   {/* ✅ FIX 12: Fees Receipt — was missing in original details modal */}
//                   <div className="bg-white/50 rounded-lg p-4">
//                     <p className="font-semibold text-black mb-2">Fees Receipt</p>
//                     {hasDocument(studentDetailsData.documents?.feesReceipt) ? (
//                       <button
//                         onClick={() => window.open(
//                           getDocumentUrl(studentDetailsData.id, 'feesReceipt'),
//                           '_blank'
//                         )}
//                         className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm"
//                       >
...
//         {/* Student List Header & Stat Cards */}
//         <div id="student-list-section" className="w-full max-w-7xl mx-auto mt-8 sm:mt-12">
...
//               }}
//             >
//               Student List & Fee status {activeFilter !== "All" && <span className="text-[#4F8CCF] text-lg sm:text-xl ml-2">({activeFilter})</span>}
//             </h2>
//             {activeFilter !== "All" && (
//               <button 
//                 onClick={() => setActiveFilter("All")}
//                 className="mt-2 sm:mt-0 px-4 py-1.5 text-sm bg-[#BEC5AD] hover:bg-[#A4B494] text-black font-semibold rounded-lg transition"
//               >
//                 Clear Filter
//               </button>
//             )}
...
//           {/* Filter Cards */}
//           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8 px-4 sm:px-0">
//             {[
//               { title: "Total Students", value: students.length, color: "text-blue-600" },
//               { title: "Paid Fees", value: students.filter(s => s.feeStatus === "Paid").length, color: "text-green-600" },
//               { title: "Pending Fees", value: students.filter(s => ["Pending", "Unpaid", "Partial"].includes(s.feeStatus)).length, color: "text-orange-500" },
//               { title: "Room Assigned", value: students.filter(s => s.room && s.room !== "Not Assigned").length, color: "text-black" },
//               { title: "Not Assigned", value: students.filter(s => !s.room || s.room === "Not Assigned").length, color: "text-red-500" }
//             ].map((card, i) => (
//               <button
//                 key={i}
//                 onClick={() => setActiveFilter(card.title)}
//                 className={`bg-[#BEC5AD] rounded-xl overflow-hidden border-2 hover:shadow-lg transition text-center relative flex flex-col justify-between p-4 ${
//                   activeFilter === card.title 
//                     ? "border-[#4F8CCF] ring-2 ring-[#4F8CCF]/50 scale-[1.02] shadow-md bg-[#A4B494]" 
//                     : "border-transparent hover:border-gray-400"
//                 }`}
//               >
//                 <div className="w-full text-center mb-2">
//                   <span className="font-semibold text-sm sm:text-base text-black">{card.title}</span>
//                 </div>
//                 <div className={`font-bold text-2xl sm:text-3xl flex justify-center items-center ${card.color}`}>
//                   {card.value}
//                 </div>
//               </button>
//             ))}
...
//               <div
//                 className="border border-black rounded-[19.6px] overflow-hidden"
//                 style={{ borderWidth: "0.98px", width: "100%" }}
//               >
//                 {/* Table Header */}
...
//                     <div
//                       key={header}
//                       className="px-2 py-3 relative flex justify-center items-center h-full"
//                       style={{
//                         fontFamily: "Poppins",
//                         fontWeight: "600",
//                         fontSize: "14px",
...
//                       }}
//                     >
//                       <span className="w-full break-words">{header}</span>
//                       {index < 6 && (
//                         <div
//                           className="absolute right-0 top-1/2 transform -translate-y-1/2"
//                           style={{
...
//                     <div key={student.id} className="text-black grid grid-cols-7 items-center border-b border-black/10 last:border-0 pb-2">
//                       <div className="px-2 py-2 break-words">{student.id}</div>
//                       <div className="px-2 py-2 break-words">{student.name}</div>
//                       <div className="px-2 py-2 break-words leading-tight">{student.room}</div>
//                       <div className="px-2 py-2 text-xs break-words">{student.contact}</div>
//                       <div className="px-2 py-2 flex justify-center items-center">
//                         <span className="font-semibold py-1 px-3 rounded-md" style={getFeeStatusStyle(student.feeStatus)}>
//                           {student.feeStatus}
//                         </span>
//                       </div>
//                       <div className="px-2 py-2 break-words">{student.dues}</div>
...
//                                 height="26"
//                               >
//                                 <rect x="0.678223" y="0.0253906" width="25.7356" height="25.7356" fill="#D9D9D9" />
//                               </mask>
//                               <g mask={`url(#mask0_221_285_${i})`}>
//                                 <path
//                                   d="M2.82373 25.7609V21.4717H24.2701V25.7609H2.82373ZM7.113 17.1824H8.61425L16.9783 8.8451L15.4503 7.31705L7.113 15.6811V17.1824ZM4.96837 19.327V14.7697L16.9783 2.78651C17.1749 2.58991 17.4028 2.438 17.6619 2.33077C17.9211 2.22354 18.1936 2.16992 18.4796 2.16992C18.7655 2.16992 19.0425 2.22354 19.3106 2.33077C19.5787 2.438 19.82 2.59885 20.0344 2.81331L21.5089 4.31456C21.7233 4.51115 21.8797 4.74349 21.978 5.01157C22.0763 5.27965 22.1255 5.55666 22.1255 5.84261C22.1255 6.11069 22.0763 6.3743 21.978 6.63345C21.8797 6.89259 21.7233 7.1294 21.5089 7.34386L9.52572 19.327H4.96837Z"
...
//                           <mask id={`mask0_mobile_${i}`} style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="27" height="26">
//                             <rect x="0.678223" y="0.0253906" width="25.7356" height="25.7356" fill="#D9D9D9" />
//                           </mask>
//                           <g mask={`url(#mask0_mobile_${i})`}>
//                             <path d="M2.82373 25.7609V21.4717H24.2701V25.7609H2.82373ZM7.113 17.1824H8.61425L16.9783 8.8451L15.4503 7.31705L7.113 15.6811V17.1824ZM4.96837 19.327V14.7697L16.9783 2.78651C17.1749 2.58991 17.4028 2.438 17.6619 2.33077C17.9211 2.22354 18.1936 2.16992 18.4796 2.16992C18.7655 2.16992 19.0425 2.22354 19.3106 2.33077C19.5787 2.438 19.82 2.59885 20.0344 2.81331L21.5089 4.31456C21.7233 4.51115 21.8797 4.74349 21.978 5.01157C22.0763 5.27965 22.1255 5.55666 22.1255 5.84261C22.1255 6.11069 22.0763 6.3743 21.978 6.63345C21.8797 6.89259 21.7233 7.1294 21.5089 7.34386L9.52572 19.327H4.96837Z" fill="#1C1B1F" />
//                           </g>
//                         </svg>
//                       </button>
//                     </div>
...
//                       <span className="text-gray-600 font-medium block text-[10px] uppercase tracking-wider mb-1">Room / Bed Details</span>
//                       <p className="text-black font-semibold leading-tight break-words text-xs">
//                         {student.room}
//                       </p>
//                     </div>
                    
//                     <div className="flex flex-col justify-center">
//                       <span className="text-gray-600 font-medium text-[10px] uppercase tracking-wider mb-1">Contact</span>
//                       <p className="text-black text-xs font-medium">{student.contact}</p>
//                     </div>

//                     <div className="flex flex-col justify-center items-end">
//                       <span className="text-gray-600 font-medium text-[10px] uppercase tracking-wider mb-1 text-right w-full">Dues</span>
//                       <p className="text-black font-bold text-sm">{student.dues}</p>
//                     </div>

//                     <div className="col-span-2 pt-2 border-t border-gray-100 flex justify-between items-center">
//                       <span className="text-gray-600 font-medium text-[10px] uppercase tracking-wider">Fee Status</span>
//                       <p className="font-bold py-1 px-3 rounded-full text-[10px] shadow-sm" style={getFeeStatusStyle(student.feeStatus)}>
//                         {student.feeStatus}
//                       </p>
//                     </div>
//                   </div>
...
//                   className={`px-4 py-2 rounded-lg border border-black font-semibold transition-colors ${
//                     currentPage === 1 
...
//                       className={`min-w-[40px] h-[40px] rounded-lg border border-black font-semibold transition-colors ${
//                         currentPage === i + 1
...
//                 <p className="ml-4 text-sm text-black font-medium">
//                   Page {currentPage} of {totalPages || 1} ({filteredStudents.length} students)
//                 </p>
//               </div>
//             )}
//           </div>
