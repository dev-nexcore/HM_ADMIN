...
//     const totalFees  = studentInvoices.reduce((s, i) => s + (i.amount || 0), 0);

//     // ── FIX: paidFees = sum of paidAmount for all invoices.
//     //    If status === "paid" and paidAmount is missing/zero, treat full amount as paid.
...
//     // ── FIX: derive status properly from calculated paidFees/pendingFees
//     let status;
